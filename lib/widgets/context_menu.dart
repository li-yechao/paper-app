...
///
/// When open, the [MyCupertinoContextMenu] shows the child, or the widget returned
...
class MyCupertinoContextMenu extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [MyCupertinoContextMenu].
  ///
  /// When the [MyCupertinoContextMenu] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [MyCupertinoContextMenu] is "closed", this widget acts like a
  ...
  /// [MyCupertinoContextMenu] is open.
  ///
  ...
  @override
  State<MyCupertinoContextMenu> createState() => _MyCupertinoContextMenuState();
}

class _MyCupertinoContextMenuState extends State<MyCupertinoContextMenu>
